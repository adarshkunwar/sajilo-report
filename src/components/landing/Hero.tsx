        ...
        <div className="flex flex-col items-center lg:flex-row">
          <div className="lg:w-1/2">
            <h1 className="text-2xl font-bold leading-tight text-gray-800 lg:text-4xl xl:text-5xl">
              ...
              <span className="text-blue-600">Have fun</span> while creating
              your <span className="text-blue-600">Reports</span>
            </h1>
            <p className="mt-6 text-gray-600 lg:text-lg">
              We provide you with the ready made templates to create your
              reports in a fun and interactive way so that you dont have to
